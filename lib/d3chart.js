...
Chart = (function() {
  ...
  Chart.prototype.getMergedSeries = function(series) {
  ...
  Chart.prototype.checkAccessorValidation = function(data) {
    if (typeof this._x(data) === 'undefined') {
      return this.errorHandler(new Chart.AccessorError(this._x, this._y, data));
    }
  ...
  Chart.prototype.inhibitOther = function(selector, opacity) {
    var svg;
    if (opacity == null) {
      opacity = 0.6;
    }
  ...
  Chart.prototype.clearInhibit = function(selector) {
    var svg;
    svg = this.svg;
    return function(d) {
  ...
  Chart.prototype.tooltipDefaultStyle = {
    width: 200,
    height: 100,
    fill: "white",
    stroke: "grey"
  ...
  Chart.prototype.showToolTip = function(d) {
    var tooltip;
  ...
  Chart.prototype.moveToolTip = function() {};

  Chart.prototype.errorHandler = function(err) {
    this.svg.append('text').attr('x', this.width / 2).attr('y', this.height / 2).text(this.opt.failMessage || "oops! draw chart fail...");
    throw err;
  };

  Chart.prototype.drawLine = function(series, opt) {
    ...
    opt = new Chart.Option(this.opt, opt);
    for (_i = 0, _len = series.length; _i < _len; _i++) {
      serie = series[_i];
      if (serie.data == null) {
        series = [
  ...
  Chart.prototype.drawBar = function(series, opt) {
  ...
  Chart.prototype.drawPie = function(series, opt) {
  ...
  Chart.prototype.drawFlow = function(data, opt) {
...
Chart.AccessorError = (function(_super) {
