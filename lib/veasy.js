...
Veasy = (function() {
  ...
  Veasy.prototype.mergeLim = function(lim, extent) {
    if (!lim) {
      lim = [];
    }
    return [lim[0] != null ? lim[0] : extent[0], lim[1] != null ? lim[1] : extent[1]];
  };
  ...
  Veasy.prototype.drawLine = function(series, opt) {
    var allXdomain, allYdomain, category10, err, height, line, mergedSeries, tickHeight, tickLabel, tickWidth, tickY, tooltipFormat, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
    ...
    allXdomain = d3.extent(mergedSeries, this._x);
    allYdomain = d3.extent(mergedSeries, this._y);
    ...
    x.domain(this.mergeLim(opt.xlim, d3.extent(allXdomain))).range([0, this.width]);
    this.yScale = y = d3.scale[yScale]();
    y.domain(this.mergeLim(opt.ylim, d3.extent(allYdomain))).range([this.height, 0]);
    ...
    if (!this.svg.select('g.xaxis')[0][0]) {
      ...
      if ((_ref3 = this.opt.axis) != null ? (_ref4 = _ref3.x) != null ? _ref4.title : void 0 : void 0) {
        xTitle = xAxis.append('text').attr('class', 'title').text((_ref5 = this.opt.axis) != null ? (_ref6 = _ref5.x) != null ? _ref6.title : void 0 : void 0).style('text-anchor', 'start');
        width = this.$target.find('svg g.xaxis text.title')[0].getBBox().width;
        height = this.$target.find('svg g.xaxis text.title')[0].getBBox().height;
        tickLabel = this.$target.find('svg g.xaxis g.tick text');
        tickHeight = d3.max(tickLabel, function(d) {
          return d.getBBox().height;
        });
        tickY = d3.max(tickLabel, function(d) {
          return d.getBBox().y;
        });
        xTitle.attr('dx', (this.width - width) / 2).attr('dy', tickHeight + tickY + height);
      }
      if ((_ref7 = this.opt.axis) != null ? (_ref8 = _ref7.y) != null ? _ref8.title : void 0 : void 0) {
        yTitle = yAxis.append('text').attr('class', 'title').text((_ref9 = this.opt.axis) != null ? (_ref10 = _ref9.y) != null ? _ref10.title : void 0 : void 0).style('text-anchor', 'start');
        width = this.$target.find('svg g.yaxis text.title')[0].getBBox().width;
        height = this.$target.find('svg g.yaxis text.title')[0].getBBox().height;
        tickLabel = this.$target.find('svg g.yaxis g.tick text');
        tickWidth = d3.max(tickLabel, function(d) {
          return d.getBBox().width;
        });
        yTitle.attr('dx', -(this.height + width) / 2).attr('dy', -(tickWidth + height));
  ...
  Veasy.prototype.drawArea = function(series, opt) {
    var allXdomain, allYdomain, area, category10, err, height, mergedSeries, tickHeight, tickLabel, tickWidth, tickY, tooltipFormat, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawStack = function(series, opt) {
    var allXdomain, allYdomain, area, category10, color, domainInEachX, err, height, l, mergedSeries, stack, stackType, stackedData, tickHeight, tickLabel, tickWidth, tickY, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yDomain, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
    ...
    opt = new Option(this.opt, opt);
    stackType = opt.stackType || "expand";
    allXdomain = d3.extent(mergedSeries, this._x);
    allYdomain = d3.extent(mergedSeries, this._y);
    domainInEachX = d3.nest().key(this._x).rollup(function(vals) {
    ...
    stack = d3.layout.stack().offset(stackType).values(function(d) {
      return d.data;
    }).y(this._y).x(this._x);
    stackedData = stack(series);
    yDomain = (typeof stack.domain === "function" ? stack.domain() : void 0) || [
      d3.min(series[0].data, function(d) {
        return d.y0;
      }), d3.max(series[series.length - 1].data, function(d) {
        return d.y + d.y0;
      })
    ];
    y.domain(this.mergeLim(opt.ylim, yDomain));
    area = d3.svg.area().x(function(d) {
      return x(_this._x(d));
    }).y0(function(d) {
      return y(d.y0);
    ...
    l = this.svg.selectAll("path.stack").data(stackedData).enter().append("path").attr('class', function(d, sid) {
    ...
    if (!this.svg.select('g.xaxis')[0][0]) {
      ...
      if ((_ref2 = this.opt.axis) != null ? (_ref3 = _ref2.x) != null ? _ref3.title : void 0 : void 0) {
        xTitle = xAxis.append('text').attr('class', 'title').text((_ref4 = this.opt.axis) != null ? (_ref5 = _ref4.x) != null ? _ref5.title : void 0 : void 0).style('text-anchor', 'start');
        width = this.$target.find('svg g.xaxis text.title')[0].getBBox().width;
        height = this.$target.find('svg g.xaxis text.title')[0].getBBox().height;
        tickLabel = this.$target.find('svg g.xaxis g.tick text');
        tickHeight = d3.max(tickLabel, function(d) {
      ...
      if ((_ref6 = this.opt.axis) != null ? (_ref7 = _ref6.y) != null ? _ref7.title : void 0 : void 0) {
        yTitle = yAxis.append('text').attr('class', 'title').text((_ref8 = this.opt.axis) != null ? (_ref9 = _ref8.y) != null ? _ref9.title : void 0 : void 0).style('text-anchor', 'start');
        width = this.$target.find('svg g.yaxis text.title')[0].getBBox().width;
        height = this.$target.find('svg g.yaxis text.title')[0].getBBox().height;
        tickLabel = this.$target.find('svg g.yaxis g.tick text');
        tickWidth = d3.max(tickLabel, function(d) {
  ...
  Veasy.prototype.drawBar = function(series, opt) {
    var allLabels, allYdomain, bandWidth, barMargin, category10, err, height, mergedSeries, tickHeight, tickLabel, tickWidth, tickY, tooltipFormat, width, x, xAxis, xTitle, xType, xaxis, y, yAxis, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
    ...
    barMargin = opt.barMargin != null ? opt.barMargin : 0.1;
    if (opt.transpose) {
      x.rangeBands([0, this.height], barMargin).domain(allLabels);
      y.domain(opt.ylim || [0, d3.extent(allYdomain)[1]]).range([0, this.width]);
    } else {
      x.rangeBands([0, this.width], barMargin).domain(allLabels);
      y.domain(opt.ylim || [0, d3.extent(allYdomain)[1]]).range([this.height, 0]);
    }
    ...
    if (!this.svg.select('g.xaxis')[0][0]) {
      if (opt.transpose) {
        ...
        if ((_ref3 = this.opt.axis) != null ? (_ref4 = _ref3.x) != null ? _ref4.title : void 0 : void 0) {
          ...
          xTitle.attr('dx', -(this.height + width) / 2).attr('dy', -(height + tickWidth));
        ...
        if ((_ref7 = this.opt.axis) != null ? (_ref8 = _ref7.y) != null ? _ref8.title : void 0 : void 0) {
          ...
          yTitle.attr('dx', (this.width - width) / 2).attr('dy', tickHeight + tickY + height);
        }
      } else {
        ...
        if ((_ref13 = this.opt.axis) != null ? (_ref14 = _ref13.x) != null ? _ref14.title : void 0 : void 0) {
          xTitle = xAxis.append('text').attr('class', 'title').text((_ref15 = this.opt.axis) != null ? (_ref16 = _ref15.x) != null ? _ref16.title : void 0 : void 0).style('text-anchor', 'start');
          width = this.$target.find('svg g.xaxis text.title')[0].getBBox().width;
          height = this.$target.find('svg g.xaxis text.title')[0].getBBox().height;
          tickLabel = this.$target.find('svg g.xaxis g.tick text');
          tickHeight = d3.max(tickLabel, function(d) {
        ...
        if ((_ref17 = this.opt.axis) != null ? (_ref18 = _ref17.y) != null ? _ref18.title : void 0 : void 0) {
          yTitle = yAxis.append('text').attr('class', 'title').text((_ref19 = this.opt.axis) != null ? (_ref20 = _ref19.y) != null ? _ref20.title : void 0 : void 0).style('text-anchor', 'start');
          width = this.$target.find('svg g.yaxis text.title')[0].getBBox().width;
          height = this.$target.find('svg g.yaxis text.title')[0].getBBox().height;
          tickLabel = this.$target.find('svg g.yaxis g.tick text');
          tickWidth = d3.max(tickLabel, function(d) {
  ...
  Veasy.prototype.drawBox = function(series, opt) {
    var allLabels, allYdomain, bandWidth, category10, height, mergedSeries, tickHeight, tickLabel, tickWidth, tickY, tooltipFormat, width, x, xAxis, xTitle, xType, xaxis, y, yAxis, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawPie = function(series, opt) {
    var category10, centeringOffset, err, innerMargin, mergedSeries, outerMargin, radius, serie, tooltipFormat, x, _ref,
      _this = this;
    if (opt == null) {
      opt = {};
    }
    ...
    radius = Math.min(x.rangeBand() / 2, this.height / 2);
    outerMargin = opt.outerMargin != null ? opt.outerMargin : 10;
    innerMargin = radius - outerMargin - 10 > 0 ? Math.min(opt.innerMargin || 0, radius - outerMargin - 10) : opt.innerMargin || 0;
    category10 = d3.scale.category10();
    centeringOffset = x.rangeBand() / 2 - radius * 1.5;
    series.forEach(function(serie, sid) {
      var arc, color, g, legend, pie, _ref;
      if (_this._color) {
        color = _this._color;
      } else if (((_ref = serie.opt) != null ? _ref.color : void 0) != null) {
        color = function(d, idx) {
      ...
      g = _this.svg.selectAll("g.arc.serie-" + sid).data(pie(serie.data)).enter().append('g').attr('class', "arc serie-" + sid).attr('transform', "translate(" + (radius + x(serie.name) + centeringOffset) + " ," + radius + ")");
      g.append('path').attr('d', arc).attr('fill', color).style("cursor", 'pointer');
      g.on('mouseover', _this.inhibitOther('g.arc')).on('touchstart', _this.inhibitOther('g.arc')).on('mouseout', _this.clearInhibit('g.arc')).on('touchend', _this.clearInhibit('g.arc'));
      legend = _this.appendLegend(serie.data.map(function(d) {
        return {
          name: _this._x(d)
        };
      }), color);
      if (legend != null) {
        return legend.attr('transform', "translate(" + (radius + x(serie.name) + centeringOffset + radius) + ", 0)");
      }
    });
    if (tooltipFormat = (_ref = this.opt.tooltip) != null ? _ref.format : void 0) {
  ...
  Veasy.prototype.drawScatterPlot = function(series, opt) {
    var allXdomain, allYdomain, category10, error, height, mergedSeries, tickHeight, tickLabel, tickWidth, tickY, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
