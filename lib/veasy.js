...
Veasy = (function() {
  ...
  Veasy.prototype.drawLine = function(series, opt) {
    var allXrange, allYrange, category10, err, height, line, mergedSeries, tickHeight, tickLabel, tickWidth, tickY, tooltipFormat, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawArea = function(series, opt) {
    var allXrange, allYrange, area, category10, err, height, mergedSeries, tickHeight, tickLabel, tickWidth, tickY, tooltipFormat, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawStack = function(series, opt) {
    var allXrange, allYrange, area, category10, color, err, height, l, mergedSeries, rangeInEachX, stack, tickHeight, tickLabel, tickWidth, tickY, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawHist = function(series, opt) {
    var allYRange, breaks, mergedSeries, serie, size, tick, _i, _j, _len, _len1, _ref,
      _this = this;
    if (opt == null) {
      opt = {};
    }
    mergedSeries = this.getMergedSeries(series);
    opt = new Option(this.opt, opt);
    breaks = opt.breaks || 10;
    allYRange = d3.extent(mergedSeries, this._y);
    _ref = [100, 500, 1000, 2000, 5000, 10000];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (allYRange[1] - allYRange[0] < size) {
        ...
        for (_j = 0, _len1 = series.length; _j < _len1; _j++) {
          ...
          serie.data = d3.nest().key(function(d) {
            return (0 | _this._y(d) / tick) * tick;
    ...
    return this.drawBar([series[1]]);
  };

  Veasy.prototype.drawBox = function(series, opt) {
    var allLabels, allYrange, bandWidth, category10, height, mergedSeries, tickHeight, tickLabel, tickWidth, tickY, tooltipFormat, width, x, xAxis, xTitle, xType, xaxis, y, yAxis, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawScatterPlot = function(series, opt) {
    var allXrange, allYrange, category10, error, height, mergedSeries, tickHeight, tickLabel, tickWidth, tickY, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
