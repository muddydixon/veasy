...
Veasy = (function() {
  ...
  Veasy.prototype.drawLine = function(series, opt) {
    var allXrange, allYrange, category10, err, line, mergedSeries, tooltipFormat, x, xAxis, xScale, xType, xaxis, y, yAxis, yScale, yType, yaxis, _ref, _ref1, _ref2,
      _this = this;
    if (opt == null) {
      opt = {};
    }
    ...
    if (!this.svg.select('g.xaxis')[0][0]) {
      ...
      yAxis = this.svg.append("g").attr('class', 'yaxis').call(yaxis).selectAll("path").attr("fill", "none").attr("stroke", "black");
    }
    return this.appendLegend(series);
  };

  Veasy.prototype.drawArea = function(series, opt) {
    var allXrange, allYrange, area, category10, err, mergedSeries, tooltipFormat, x, xAxis, xScale, xType, xaxis, y, yAxis, yScale, yType, yaxis, _ref, _ref1, _ref2,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawStack = function(series, opt) {
    var allXrange, allYrange, area, category10, color, err, l, mergedSeries, rangeInEachX, stack, x, xAxis, xScale, xType, xaxis, y, yAxis, yScale, yType, yaxis, _ref, _ref1,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawBar = function(series, opt) {
    var allLabels, allYrange, bandWidth, category10, err, mergedSeries, tooltipFormat, x, xAxis, xType, xaxis, y, yAxis, yType, yaxis, _ref, _ref1, _ref2, _ref3, _ref4,
      _this = this;
    if (opt == null) {
      opt = {};
    }
    ...
    if (!this.svg.select('g.xaxis')[0][0]) {
      if (opt.transpose) {
        ...
        yAxis = this.svg.append("g").attr('class', 'yaxis').call(yaxis).attr("transform", "translate(0," + this.height + ")").selectAll("path").attr("fill", "none").attr("stroke", "black");
      } else {
        xaxis = getAxis(x, new Option({}, (_ref3 = this.opt.axis) != null ? _ref3.x : void 0));
        yaxis = getAxis(y, new Option({
          orient: 'left'
        }, (_ref4 = this.opt.axis) != null ? _ref4.y : void 0));
  ...
  Veasy.prototype.drawScatterPlot = function(series, opt) {
    var allXrange, allYrange, category10, error, mergedSeries, x, xAxis, xScale, xType, xaxis, y, yAxis, yScale, yType, yaxis, _ref, _ref1,
      _this = this;
    if (opt == null) {
      opt = {};
    }
