...
Veasy = (function() {
  ...
  Veasy.prototype.drawLine = function(series, opt) {
    var allXrange, allYrange, category10, err, line, mergedSeries, tooltipFormat, x, xAxis, xScale, xType, xaxis, y, yAxis, yScale, yType, yaxis, _ref,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawArea = function(series, opt) {
    var allXrange, allYrange, area, category10, err, mergedSeries, tooltipFormat, x, xAxis, xScale, xType, xaxis, y, yAxis, yScale, yType, yaxis, _ref,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawStack = function(series, opt) {
    var allXrange, allYrange, area, category10, color, err, l, mergedSeries, stack, x, xAxis, xScale, xType, xaxis, y, yAxis, yScale, yType, yaxis,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawBar = function(series, opt) {
    var allLabels, allYrange, bandWidth, category10, err, mergedSeries, tooltipFormat, x, xAxis, xType, xaxis, y, yAxis, yType, yaxis, _ref,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawScatterPlot = function(series, opt) {
    var allXrange, allYrange, category10, error, mergedSeries, x, xAxis, xScale, xType, xaxis, y, yAxis, yScale, yType, yaxis,
      _this = this;
    if (opt == null) {
      opt = {};
    }
