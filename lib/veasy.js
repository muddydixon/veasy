...
Veasy = (function() {
  ...
  Veasy.prototype.appendLegend = function(series, color) {
    var $list, category10, height, left, legend, list, padding, rect, theight, top, twidth, width, _ref, _ref1, _ref2, _ref3, _ref4,
      _this = this;
    ...
    if ((_ref1 = this._legend.position) != null ? _ref1.match('n') : void 0) {
      top = 20;
    }
    if ((_ref2 = this._legend.position) != null ? _ref2.match('w') : void 0) {
      left = 20;
    }
    if ((_ref3 = this._legend.position) != null ? _ref3.match('s') : void 0) {
      top = this.height - height - 20;
    }
    if ((_ref4 = this._legend.position) != null ? _ref4.match('e') : void 0) {
  ...
  Veasy.prototype.drawLine = function(series, opt) {
    var allXrange, allYrange, category10, err, height, line, mergedSeries, tooltipFormat, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
    ...
    if (!this.svg.select('g.xaxis')[0][0]) {
      ...
      if ((_ref7 = this.opt.axis) != null ? (_ref8 = _ref7.y) != null ? _ref8.title : void 0 : void 0) {
        ...
        yTitle.attr('dx', -(this.height - height) / 2).attr('dy', -height * 2);
  ...
  Veasy.prototype.drawArea = function(series, opt) {
    var allXrange, allYrange, area, category10, err, height, mergedSeries, tooltipFormat, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawStack = function(series, opt) {
    var allXrange, allYrange, area, category10, color, err, height, l, mergedSeries, rangeInEachX, stack, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawBar = function(series, opt) {
    var allLabels, allYrange, bandWidth, category10, err, height, mergedSeries, tooltipFormat, width, x, xAxis, xTitle, xType, xaxis, y, yAxis, yTitle, yType, yaxis, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
  ...
  Veasy.prototype.drawPie = function(series, opt) {
    ...
    opt = new Option(this.opt, opt);
    this.svg.attr('transform', '').attr('width', this.width + this.margin[0] * 2).attr('height', this.height + this.margin[1] * 2);
    radius = Math.min((this.width + this.margin[0] * 2) / series.length, this.height + this.margin[1] * 2) / 2;
    outerMargin = opt.outerMargin || 10;
    innerMargin = Math.min(opt.innerMargin || 0, radius - outerMargin - 10);
    this.xScale = x = d3.scale.ordinal().rangeBands([0, this.width + this.margin[0] * 2], 0.1).domain((function() {
  ...
  Veasy.prototype.drawScatterPlot = function(series, opt) {
    var allXrange, allYrange, category10, error, height, mergedSeries, width, x, xAxis, xScale, xTitle, xType, xaxis, y, yAxis, yScale, yTitle, yType, yaxis, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if (opt == null) {
      opt = {};
    }
